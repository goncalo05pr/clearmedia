...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-[9999] bg-black" style={{ background: "#0a0a0a !important", backgroundColor: "#0a0a0a !important", opacity: "1 !important" }}>
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-5 sm:px-6 bg-black" style={{ background: "#0a0a0a !important", backgroundColor: "#0a0a0a !important", opacity: "1 !important" }}>
        <Link
          href="/"
